@props(['comment'])
<div id="dropdownComment1" x-cloak x-show="openDropdown" class="z-10 w-36 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600"
...
style="position:absolute;right:0;top:43px"
>
